  ...
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      <button class="btn btn-primary shadow-md mr-2">
        <UserPlusIcon class="w-4 h-4 mr-2" /> Contacts
      </button>
    ...
    <div class="col-span-12 xl:col-span-4 2xl:col-span-3">
      <div class="box intro-y">
        <div class="flex items-center px-5 pt-5">
          <div
            class="w-5 h-5 flex items-center justify-center text-xs text-white rounded-full bg-primary font-medium"
          >
            7
          </div>
          <div class="font-medium ml-2">Unread Messages</div>
        ...
        <div class="h-[642px] overflow-y-auto scrollbar-hidden">
          <div
            ...
            :key="fakerKey"
            class="cursor-pointer flex items-start border-b border-t border-slate-200/60 dark:border-darkmode-400 hover:bg-slate-50 dark:hover:bg-darkmode-400/50 py-5 px-5 -mb-px last:border-b-0"
            :class="{
          ...
          >
            ...
            <div class="ml-2 overflow-hidden flex-1">
              ...
              <div class="flex mt-2">
                ...
                <div
                  v-if="faker.trueFalse[0]"
                  class="w-5 h-5 flex items-center justify-center text-xs text-white rounded-full bg-primary font-medium -mt-1"
                >
        ...
        <div class="h-[768px] flex flex-col">
            ...
            <div class="flex items-center">
              ...
              <div class="ml-3 mr-auto">
                <div class="flex items-center">
                  ...
                  <div
                    class="flex items-center px-2 py-0.5 text-xs ml-2 bg-success/20 border border-success/20 text-success rounded-md"
                  >
                    <div
          ...
          <div class="overflow-y-scroll scrollbar-hidden px-5 pt-5 flex-1">
            <div class="flex items-end float-left mb-10">
              ...
              <div class="-mb-6">
                <div
                  class="bg-slate-100 border border-slate-200/60 dark:bg-darkmode-400 px-4 py-3 text-slate-500 rounded-md"
                >
            ...
            <div class="flex items-end float-left mb-10">
              ...
              <div class="-mb-6">
                <div
                  class="bg-slate-100 dark:bg-darkmode-400 px-4 py-3 text-slate-500 rounded-md"
                >
                  Lorem ipsum sit amen dolor, lorem ipsum sit amen dolor
                </div>
          ...
          >
            <textarea
              class="h-[46px] form-control dark:bg-darkmode-600 h-16 resize-none border-transparent px-5 py-3 shadow-none focus:border-transparent focus:ring-0"
              rows="1"
