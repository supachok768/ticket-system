<template>
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="flex items-center text-lg font-medium mr-auto">Profile</h2>
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      <button class="btn btn-primary shadow-md mr-2">
        <PencilIcon class="w-4 h-4 mr-2" /> Update Profile
      </button>
      <button class="btn btn-outline-secondary shadow-md">
        <DownloadIcon class="w-4 h-4 mr-2" /> View Profile
      </button>
    </div>
  </div>
  <div class="grid grid-cols-12 gap-5 mt-5">
    ...
    <div class="col-span-12">
      <div class="box intro-y px-3 pt-3 pb-5">
        <div
          class="image-fit h-80 before:content-[''] before:absolute before:w-full before:h-full before:bg-gradient-to-b from-black/20 to-black before:rounded-md before:z-10"
        >
          <img
            alt="Rocketman - HTML Admin Template"
            class="rounded-md md:object-[0px_-170px]"
            src="@/assets/images/preview-16.jpg"
          />
        </div>
        <div
          class="flex flex-col 2xl:flex-row items-center justify-center text-center 2xl:text-left"
        >
          <div class="-mt-20 2xl:-mt-10 2xl:ml-10 z-20">
            <div
              class="image-fit w-40 h-40 rounded-full border-4 border-white shadow-md overflow-hidden"
            >
              <img
                alt="Rocketman - HTML Admin Template"
          ...
          <div class="2xl:ml-5">
            ...
            <div
              class="mt-2 text-slate-500 flex items-center justify-center 2xl:justify-start"
            >
              <BriefcaseIcon class="w-4 h-4 mr-2" /> Frontend Engineer at
              Left4code Express
            </div>
            <div
              class="mt-2 text-slate-500 flex items-center justify-center 2xl:justify-start"
            >
              <MapPinIcon class="w-4 h-4 mr-2" /> New York, USA
            </div>
          </div>
          <div
            class="mx-auto grid grid-cols-2 gap-y-2 md:gap-y-0 gap-x-5 h-20 mt-5 2xl:border-l 2xl:border-r border-dashed border-slate-200 px-10 mb-6 2xl:mb-0"
          >
            <div
              class="col-span-2 md:col-span-1 flex items-center justify-center 2xl:justify-start"
            >
            ...
            <div
              class="col-span-2 md:col-span-1 flex items-center justify-center 2xl:justify-start"
            >
              <instagramIcon class="w-4 h-4 mr-2" /> @johnnydepp
            </div>
            <div
              class="col-span-2 md:col-span-1 flex items-center justify-center 2xl:justify-start"
            >
              <TwitterIcon class="w-4 h-4 mr-2" /> Johnny Depp
            </div>
            <div
              class="col-span-2 md:col-span-1 flex items-center justify-center 2xl:justify-start"
            >
              <LinkedinIcon class="w-4 h-4 mr-2" /> Johnny Depp
            </div>
          </div>
          <div class="flex 2xl:mr-10 mt-5">
            <button class="btn btn-primary mr-2 w-32">
              <UserPlusIcon class="w-4 h-4 mr-2" /> Following
            </button>
            <button class="btn btn-outline-secondary w-32">
              <UserCheckIcon class="w-4 h-4 mr-2" /> Add Friend
            </button>
          </div>
        </div>
      </div>
    ...
    <div class="col-span-12 xl:col-span-8">
      <div class="box intro-y p-5">
        ...
        <div class="leading-relaxed">
          <p class="mt-5">{{ $f()[0].news[0].content }}</p>
          <p class="mt-5">{{ $f()[0].news[1].content }}</p>
          <button
            class="btn btn-outline-secondary border-slate-200/60 w-full flex mt-5"
          >
            <ChevronDownIcon class="w-4 h-4 mr-2" /> View More
          </button>
        </div>
      </div>
      <div class="box intro-y p-5 mt-5">
        ...
        <div>
          ...
          >
            <div class="mr-5">
              <div
                class="w-16 h-16 rounded-full bg-slate-200 dark:bg-darkmode-400 flex items-center justify-center text-base font-medium"
              >
                SU
              </div>
            </div>
            <div>
              ...
              <ul class="mt-5 sm:mt-3 list-disc -ml-16 sm:ml-3">
                ...
                <li class="mb-1 last:mb-0">
                  Develop new features and infrastructure development in support
                  of rapidly emerging business and project requirements.
                </li>
                <li class="mb-1 last:mb-0">
                  Assume leadership of new projects from conceptualization to
                  deployment.
                </li>
                <li class="mb-1 last:mb-0">
          ...
          >
            ...
            <div>
              ...
              <ul class="mt-5 sm:mt-3 list-disc -ml-16 sm:ml-3">
                ...
                <li class="mb-1 last:mb-0">
                  Engage with inspiring designers and front end engineers, and
                  collaborate with leading back end engineers as we create
                  reliable APIs
                </li>
                <li class="mb-1 last:mb-0">
      ...
      <div class="box intro-y p-5 mt-5">
        ...
        <div class="flex flex-wrap">
          <div
            class="px-3 py-1 bg-primary/10 border border-primary/10 rounded-full mr-2 mb-2"
          >
            Ruby
          </div>
          <div
        ...
        <div class="grid grid-cols-12 gap-y-7">
          <div class="col-span-12 sm:col-span-6 2xl:col-span-4 flex">
            ...
            <div class="ml-5">
              ...
              <button
                class="btn btn-outline-secondary btn-rounded py-1 px-3 mt-2"
              >
                <PlusIcon class="w-4 h-4 mr-1" /> Follow
              </button>
            </div>
          </div>
          <div class="col-span-12 sm:col-span-6 2xl:col-span-4 flex">
      ...
      <div class="box intro-y p-5 mt-5">
        ...
        <div>
          <div
            ...
            :key="fakerKey"
            class="flex items-center border-b border-slate-200 border-dashed pb-5 mb-5 last:border-b-0 last:pb-0 last:mb-0"
          >
            <div>
            ...
            <div
              class="w-full ml-5 flex 2xl:items-center gap-y-3 flex-col 2xl:flex-row"
            >
              <div class="mr-auto">
              ...
              <div class="flex">
                <button class="btn btn-outline-secondary py-1 px-2">
                  <UserCheckIcon class="w-4 h-4 mr-2" /> Friends
                </button>
              </div>
            </div>
          </div>
