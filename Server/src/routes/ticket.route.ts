...
import { CreateTicketDto, BuyTicketDto } from '@dtos/ticket.dto';
...
class TicketRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}/buy`, authMiddleware, validationMiddleware(BuyTicketDto, 'body'), this.ticketController.buyTicket);
